...
void cargarArchivo(Equipos vecEquipos[], FILE *regEquipos, int n)
{
	...
	strcpy(vecEquipos[12].federacion, "Conmebol");
	...
	strcpy(vecEquipos[24].federacion, "UEFA");
	...
	strcpy(vecEquipos[31].federacion, "AFC");
